...
sphinx_gallery_conf = {
    "doc_module": "surfify",
    "backreferences_dir": os.path.join("surfify", "gallery"),
    "examples_dirs": os.path.join(os.pardir, "examples"),
    "gallery_dirs": "auto_gallery",
    "reference_url": {"surfify": None}}
...
project = u"surfify"
copyright = u"""{0}, surfify developers <antoine.grigis@cea.fr>""".format(
...
# [howto/manual]).
latex_documents = [
    ("index", "surfify.tex", "surfify Documentation", """surfify developers""",
     "manual"),
]
